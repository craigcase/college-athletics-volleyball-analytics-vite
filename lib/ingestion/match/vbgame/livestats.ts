...
export function parseLiveStatsVbgame(xml: string, sourceUrl: string, ourTeamNames: string[]): ParsedMatchSource {
  ...
  return {
    ...
    producer: 'livestats_vbgame',
    timeline: parseVbgameTimeline(xml, 'livestats_vbgame', context),
  };
}
